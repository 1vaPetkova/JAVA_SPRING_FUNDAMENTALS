...
import com.example.java_spring_fund_lab_01.services.impl.MobileleUser;
...
//    }
    ...
    public String addOffer(@Valid OfferAddBindingModel offerAddBindingModel,
        ...
        if (bindingResult.hasErrors()) {
            redirectAttributes.addFlashAttribute("offerAddBindModel", offerAddBindingModel)
                    .addFlashAttribute("org.springframework.validation.BindingResult.offerAddBindingModel", bindingResult)
                    .addFlashAttribute("brandsModels", this.brandService.getAllBrands());
            return "redirect:/offers/add";
        }
        OfferAddServiceModel savedOfferAddServiceModel = this.offerService.addOffer(offerAddBindingModel, user.getUserIdentifier());
